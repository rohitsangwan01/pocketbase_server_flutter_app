...
class PocketbaseService : Service() {
    ...
    private fun sendBroadcastEvent(type: String, event: String) {
        val intent = Intent(MainActivity.broadcastEventAction)
        intent.putExtra(MainActivity.broadcastEventType, type)
        intent.putExtra(MainActivity.broadcastEventData, event)
